...
class RecurrentPopulation(object):
        ...
        for c in self.source_connection_list:
            if(c.conn_type == 'LongRange'):
                ...
                try:
                    ...
                    # then have name and signature
                    curr_input = self.total_inputlrk_dict.setdefault(c.connection_distribution,0)
                self.total_inputlrk_dict[c.connection_distribution] = 0.0 +  c.nsyn/self.dt
    ...
    def update_total_nmdajump_dict(self):
        ...
        for c in self.source_connection_list:
            if(c.conn_type == 'LongRange'):
                ...
                self.nmdakeep_dict[c.connection_distribution] += c.curr_Inmda * self.dt
    ...
    def update_total_input_dict(self):
        ...
        for c in self.source_connection_list:
            if (c.conn_type == 'LongRange'):
                self.total_inputlrk_dict[c.connection_distribution] +=  c.nsyn /self.dt
