...
class Connection(object):
    ...
    Output pair
    """
    def __init__(self,pre,post,nsyn,weights,probs):
...
class RecurrentPopulation(object):
    ...
    def initialize_fpmusigv_dict(self):
        ...
        for c in self.source_connection_list:
            ...
            print 'connection_distribution: ',c.connection_distribution
    ...
    def initialize_total_input_dict(self):
        ...
        for c in self.source_connection_list:
            ...
            try:
                ...
                # then have name and signature
                curr_input = self.total_input_dict.setdefault(c.connection_distribution,0)
            self.total_input_dict[c.connection_distribution] = curr_input + c.curr_firing_rate * c.nsyn
            print 'connection_distribution: ',c.connection_distribution
    ...
    def update_total_input_dict(self):
        ...
        # have already exist
        for curr_CD in self.total_input_dict.keys():
            self.total_input_dict[curr_CD] = 0.0
        for c in self.source_connection_list:
        # for c in self.total_input_dict.keys():
            self.total_input_dict[c.connection_distribution] += c.curr_firing_rate * c.nsyn
    ...
    def update_total_fpmu_dict(self):
        ...
        # have already exist
        for curr_CD in self.total_input_dict.keys():
            self.total_fpmu_dict[curr_CD] = 0.0
        for c in self.source_connection_list:
