...
def get_simulation(dv=.001,dt=1e-4,tf = 0.1, verbose=False, update_method='exact', approx_order=None, tol=1e-8):
    ...
    e1_e2 = Connection(e1, e2, 100, weights= .046, probs=1.,conn_type = 'LongRange')
    e1_i2 = Connection(e1, i2, 100, weights= .058, probs=1.,conn_type = 'LongRange')
    # long-range recurrent connection
    e2_e1 = Connection(e2, e1, 100, weights= .046, probs=1.,conn_type = 'LongRange')
    e2_i1 = Connection(e2, i1, 100, weights= .058, probs=1.,conn_type = 'LongRange')
    # long-range recurrent connection
    e3_e2 = Connection(e3, e2, 100, weights= .046, probs=1.,conn_type = 'LongRange')
    e3_i2 = Connection(e3, i2, 100, weights= .058, probs=1.,conn_type = 'LongRange')
    # long-range recurrent connection
    e2_e3 = Connection(e2, e3, 100, weights= .046, probs=1.,conn_type = 'LongRange')
    e2_i3 = Connection(e2, i3, 100, weights= .058, probs=1.,conn_type = 'LongRange')
    
    simulation = Simulation([b0,b1,e1,i1,i2,e2,i3,e3], [b0_e1,b0_i1,b1_i2,b1_e2,b1_i3,b1_e3,e1_e1,e1_i1,i1_i1,i1_e1,
                            e2_e2,e2_i2,i2_i2,i2_e2,e3_e3,e3_i3,i3_i3,i3_e3,e1_e2,e1_i2,e2_e1,e2_i1,e2_e3,e2_i3,e3_e2,e3_i2], verbose=verbose)
