...
def get_simulation(dv=.001,dt=1e-4,tf = 0.1, verbose=False, update_method='exact', approx_order=None, tol=1e-8):
    ...
    bi0 = ExternalPopulation(si1,dt) # inh
    b1 = ExternalPopulation(s2,dt) # exc
    bi1 = ExternalPopulation(si2,dt) # inh
    # column 0
    e00 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)    
    i00 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)
    e01 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)    
    i01 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)
    # column 1
    e10 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)    
    i10 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)
    e11 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)    
    i11 = RecurrentPopulation(dt = dt,v_min=-1.0, v_max=1.0, dv=dv, update_method=update_method, approx_order=approx_order, tol=tol)

    # column 0
    # feedforward connection
    b0_e00  = Connection(b0, e00, 1, weights= .058, probs=1.,conn_type = 'ShortRange')
    bi1_i00 = Connection(bi1, i00, 1, weights= .058, probs=1.,conn_type = 'ShortRange')

    # feedforward connection
    b1_e01  = Connection(b1, e01, 1, weights= .058, probs=1.,conn_type = 'ShortRange')
    ...
    # column 1
    # feedforward connection
    b1_e10  = Connection(b1, e10, 1, weights= .058, probs=1.,conn_type = 'ShortRange')
    bi1_i10 = Connection(bi1, i10, 1, weights= .058, probs=1.,conn_type = 'ShortRange')

    # feedforward connection
    b1_e11  = Connection(b1, e11, 1, weights= .058, probs=1.,conn_type = 'ShortRange')
    ...
    simulation = Simulation([b0,b1,bi0,bi1,e00,i00,e01,i01,e10,i10,e11,i11], [b0_e00,bi1_i00,b1_e01,bi1_i01,
        e00_e00,i00_e00,e00_i00,i00_i00,e01_e01,i01_e01,e01_i01,i01_i01,e00_e01,i00_e01,e00_i01,i00_i01,e01_e00,i01_e00,e01_i00,i01_i00,
        b1_e10,bi1_i10,b1_e11,bi1_i11,e10_e10,i10_e10,e10_i10,i10_i10,e11_e11,i11_e11,e11_i11,i11_i11,e10_e11,i10_e11,e10_i11,i10_i11,e11_e10,i11_e10,e11_i10,i11_i10,
        e00_e10,e00_i10,e01_e11,e01_i11,e10_e00,e10_i00,e11_e01,e11_i01,e00_e10s,e00_i10s,e01_e11s,e01_i11s,e10_e00s,e10_i00s,e11_e01s,e11_i01s], verbose=verbose)
